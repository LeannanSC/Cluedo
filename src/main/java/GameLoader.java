...
public class GameLoader {
	...
	public void initWeaponTokens(List<WeaponTokens> weaponTokens) {
		List<WeaponTokens> clone = weaponTokens;
		List<String> availableRooms = Arrays.asList("Ballroom", "Kitchen", "Dining Room", "Lounge", "Hall", "Study", "Library", "Billiard Room", "Conservatory");
		// Go through all weapon tokens
		while (!clone.isEmpty()) {
			for (WeaponTokens weapon : clone) {
